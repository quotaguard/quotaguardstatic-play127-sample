...
public class Application extends Controller {
   ...
   try{
      ...
      String database = "d50vt48u98fijd";
      String DB_URL="jdbc:postgresql://54.235.245.180:5432/"+database+"?ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory";
...
// access "default" database
   ...
   try{
      //STEP 2: Register JDBC driver
      Class.forName("org.postgresql.Driver");
      String database="d34k8b4beftec0";
      String DB_URL="jdbc:postgresql://54.204.44.31:5432/"+database+"?ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory";
    String USER = "wqqopaejlphvhi";
    String PASS="uuVUTBzLqCbcyiSIcILPWUhztZ";
      //STEP 3: Open a connection
      System.out.println("Connecting to database...");
      conn = DriverManager.getConnection(DB_URL,USER,PASS);
      //STEP 4: Execute a query
